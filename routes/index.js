...
// Coen 10
router.get('/coen10', ensureAuthenticated, function(req, res){
    res.render('coen10', req.user);
});

router.post('/coen10', function(req, res) {
    // req.flash('success_msg', 'Updated Profile');
    res.redirect('/coen10');
    User.updateUser(req.body);
});
...
//Coen 11
router.get('/coen11', ensureAuthenticated, function(req, res){
    res.render('coen11', req.user);
});

router.post('/coen11', function(req, res) {
    res.redirect('/coen11');
    User.updateUser(req.body);
});

//Coen 12
router.get('/coen12', ensureAuthenticated, function(req, res){
    res.render('coen12', req.user);
});
